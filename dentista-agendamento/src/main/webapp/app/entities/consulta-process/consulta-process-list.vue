  ...
  <div>
    <h2 class="jh-entity-heading" data-cy="consultaProcessDetailsHeading">
      ...
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="`/process-definition/Consulta/init`" tag="button" class="btn btn-primary mr-2">
          ...
          <tr v-for="consultaProcess in consultaProcessList" :key="consultaProcess.id" data-cy="entityTable">
            ...
            <td>
              <div v-if="consultaProcess.processInstance">
                <router-link :to="`/process-definition/Consulta/instance/${consultaProcess.processInstance.id}/view`">
            ...
            <td class="text-right">
              <div class="btn-group">
                <router-link
                  :to="`/process-definition/Consulta/instance/${consultaProcess.processInstance.id}/view`"
                  tag="button"
