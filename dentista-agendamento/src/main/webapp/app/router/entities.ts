...
export default [
  ...
  {
    path: '/process-definition/ConsultaProcess/task/CadastroProcess/:taskInstanceId/view',
    name: 'ConsultaProcess_CadastroProcessDetails',
    component: ConsultaProcess_CadastroProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/task/CadastroProcess/:taskInstanceId/execute',
    name: 'ConsultaProcess_CadastroProcessExecute',
    component: ConsultaProcess_CadastroProcessExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/instance/:processInstanceId/view',
    name: 'ConsultaProcessView',
    component: ConsultaProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/instances',
    name: 'ConsultaProcessList',
    component: ConsultaProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/init',
    name: 'ConsultaStartFormInit',
    component: ConsultaStartFormInit,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/task/InfoCadastro/:taskInstanceId/view',
    name: 'ConsultaProcess_InfoCadastroDetails',
    component: ConsultaProcess_InfoCadastroDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/task/InfoCadastro/:taskInstanceId/execute',
    name: 'ConsultaProcess_InfoCadastroExecute',
    component: ConsultaProcess_InfoCadastroExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/task/SelConsulta/:taskInstanceId/view',
    name: 'ConsultaProcess_SelConsultaDetails',
    component: ConsultaProcess_SelConsultaDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/ConsultaProcess/task/SelConsulta/:taskInstanceId/execute',
